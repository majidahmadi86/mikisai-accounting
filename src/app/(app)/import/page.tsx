...
export default async function ImportPage() {
  ...
  const { data } = await supabase.from("platform_settings").select("platform, commission_pct, fixed_fee");
  ...
  return (
    <div>
      ...
      <ImportWorkbench settings={settings} defaultReceivedBy={profile.display_name === "Sai" ? "sai" : "mike"} />
    </div>
  );
}
