...
const sugar: Product = { id: "p-sugar", name: "Coconut sugar", name_th: "", product_line: "sugar", variant: "10 kg", unit_label: "box", default_cost: 0, default_price: 399, list_prices: {}, low_stock_threshold: 3, active: true, photo_path: null, notes: "", stock_mode: "stocked" };
